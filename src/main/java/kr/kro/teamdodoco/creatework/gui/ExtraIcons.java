package kr.kro.teamdodoco.creatework.gui;

import com.mojang.blaze3d.systems.RenderSystem;
import com.mojang.blaze3d.vertex.PoseStack;
import com.mojang.blaze3d.vertex.VertexConsumer;
import com.simibubi.create.foundation.gui.AllIcons;
import kr.kro.teamdodoco.creatework.Creatework;
...
public class ExtraIcons extends AllIcons
{
    public static final ResourceLocation ICON_ATLAS = ResourceLocation.fromNamespaceAndPath(Creatework.ID, "textures/gui/icons.png");
    ...
    static ExtraIcons next()
    {
        return new ExtraIcons(++x, y);
    }

    static ExtraIcons newRow()
    {
        return new ExtraIcons(x = 0, ++y);
    }
